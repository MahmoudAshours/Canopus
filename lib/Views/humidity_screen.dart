              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        '${value['properties']['parameter']['RH2M'].keys.toList().map((m) => value['properties']['parameter']['RH2M'][m]).reduce((a, b) => roundDouble(a + b / value['properties']['parameter']['RH2M'].keys.toList().length, 2))} m/s',
                        style:
