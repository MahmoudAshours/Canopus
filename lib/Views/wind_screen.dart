              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        '${value['properties']['parameter']['WS10M_MAX'].keys.toList().map((m) => value['properties']['parameter']['WS10M_MAX'][m]).reduce((a, b) => roundDouble(a + b / value['properties']['parameter']['WS10M_MAX'].keys.toList().length, 2))} m/s',
                        style:
