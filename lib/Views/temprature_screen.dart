              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: Text(
                        '${value['properties']['parameter']['T2M_MAX'].keys.toList().map((m) => value['properties']['parameter']['T2M_MAX'][m]).reduce((a, b) => a + b) / value['properties']['parameter']['T2M_MAX'].keys.toList().length}',
